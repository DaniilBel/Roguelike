...
При достижении определенного HP у монстра, он меняет поведение и восстанавливат его с определеной вероятностью.
При это об него всё ещё можно убиться.

Уровни забиваются вручную, либо можно указать файл, откуда их брать
